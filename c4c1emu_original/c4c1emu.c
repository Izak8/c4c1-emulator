...
unsigned int ROM[256] = 
{
	0x3FC02000,		//Input a number
	0x3FA00020,		//Add it to AX: AX is intially zero
	0x3FE00000,		//Output AX
	0x3E000000
};	
...
void main() {
 //Need to understand file descriptors for STDIN and normal file to read stuff
